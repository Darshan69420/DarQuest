...
export const LORE = {
  ...
  sorrowshade: 'Grief that forgot the person it belonged to, and kept on wandering.',
  deathless: 'Malvoren\'s legion. They cannot die; they can only be persuaded to stop.',
  bone_magus: 'Wizards who traded their flesh for a longer life. It did not go as planned.',
  bone_colossus: 'A thousand skeletons, stacked into one very angry giant.',
  pale_templar: 'The Magister\'s chosen guard, sworn to him in life and after it.',
  soul_anchor: 'An obelisk that chains a stolen soul to Malvoren\'s ward.',
  echo_hollowmere: 'A memory of Lord Hollowmere, kept in Malvoren\'s halls like a trophy.',
  echo_pyrrhon: 'A memory of the Molten King, still burning.',
  echo_sylvara: 'A memory of the Frozen Queen, from before you freed her.',
  malvoren: 'Orvyn\'s brightest student. He wanted to rewrite the world\'s magic, and did not care who he had to erase.',
  briar_stalker: 'Forest cats whose fur the blight turned to thorns. They still purr, horribly.',
  pixie: 'Fae who once guided lost travellers home, now enchanted to lead them astray.',
  spore_shambler: 'Mushrooms that learned to walk. Stand back when they sneeze.',
  treant: 'Ancient tree-folk, woken in a blight-fuelled rage.',
  blight_horror: 'Malvoren\'s rot given a body, and one very large eye.',
  blight_pod: 'A swollen seed that pours its sap into the Thornmother.',
  thornmother: 'Once the forest\'s protector. The blight turned her love for it into a hunger.',
...
export const ACHIEVEMENTS = [
  ...
  A('malvoren', 'Legend of Starfall', '🌟', 'Defeat Malvoren, the Pale Magister, and finish the Chronicle', p => (p.bestiary?.malvoren || 0) > 0, { gold: 5000, title: 'the Legend' }),
