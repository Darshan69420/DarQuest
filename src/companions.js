...
export const COMPANIONS = {
  aria:    { name: 'Aria Frostmere',   school: 'frost',   role: 'Guardian',  price: 400,  level: 4,  support: 'shield',    spells: ['frost_sprite', 'ice_golem'],                 desc: 'Wraps you in frost wards and chills your foes.',       look: { hair: 0xdff6ff, hatStyle: 'hood', eyeColor: 0x4dc8ff } },
  bram:    { name: 'Bram Thornwood',   school: 'verdant', role: 'Healer',    price: 600,  level: 6,  support: 'heal',      spells: ['seedling', 'thornling'],                     desc: 'Heals you whenever you get hurt.',                   look: { hair: 0x6a4a2a, beard: true, eyeColor: 0x2e7d3b } },
  zephyra: { name: 'Zephyra Voltaire', school: 'tempest', role: 'Striker',   price: 800,  level: 8,  support: null,        spells: ['thunder_sprite', 'storm_shark', 'thunder_roc'], desc: 'Hits like a lightning strike. Often.',               look: { hair: 0xf2f0ff, eyeColor: 0xb46bff, goggles: true } },
  morrow:  { name: 'Morrow Gloam',     school: 'umbral',  role: 'Leech',     price: 800,  level: 8,  support: 'drainheal', spells: ['shade_bite', 'ghoul_claw'],                  desc: 'Drains life from foes and shares it with you.',      look: { hair: 0x2a2030, hatStyle: 'hood', eyeColor: 0x9a8cff } },
  kindle:  { name: 'Kindle Ashbright', school: 'blaze',   role: 'Burner',    price: 1000, level: 10, support: null,        spells: ['ember_imp', 'kindle', 'fire_serpent'],       desc: 'Sets everything on fire. Everything.',               look: { hair: 0xff7a2a, eyeColor: 0xff6a2b } },
  sol:     { name: 'Sol Starweaver',   school: 'arcane',  role: 'Tactician', price: 1200, level: 12, support: 'blade',     spells: ['arcane_bolt', 'sphinx_sands', 'scarab_swarm'], desc: 'Sharpens your spells and softens up your foes.',     look: { hair: 0xf2c14e, glasses: true, eyeColor: 0xf2c14e } },
};
