...
export const NPCS = {
  ...
  mirabel: {
    ...
    lines: ['Every level you gain earns you a Training Point. Bring them to me and we will turn them into spells together.',
            'A spell is a promise you make to your wand. Break it, and the wand remembers.',
            'Do your reading, practice your circles, and never duel on an empty stomach. That is the whole secret.'],
  },
  fizz: {
  ...
  brannoc: {
    ...
    lines: ['Hollow Lane was a cheerful street once. Now the shadows have moved in and stopped paying rent.',
            'My watch used to chase off the odd tipsy student. These days we bar the doors and count the lamplights.'],
  },
  kestra: {
  ...
  kael: {
    ...
    lines: ['The dragons came back three winters ago. We have been holding this camp ever since, one cold night at a time.',
            'Watch the ground when a dragon breathes in. If it glows, MOVE.',
            'A wizard with the Voice... I never thought I would see one. The old songs owe me an apology.'],
  },
  vaelith: {
...
export const QUESTS = [
  ...
  },
  {
    ...
    offer: 'Down Hollow Lane, south through the gate, the shadows have sprouted weeds. Gloomsprigs, we call them: all thorns and bad temper. Defeat 3 of them and show me your spark is more than a spark.',
    done: 'Three fewer weeds, and not a singed eyebrow on you. Take these coins, and a potion from Madame Fizz\'s stock. She swears it tastes of raspberries. It does not.',
  ...
  },
  {
    ...
    offer: 'You\'re the new apprentice? Good. Cinder Rats are nesting in the gutters and setting the lane alight, one whisker at a time. Put out 4 of them for me.',
    done: 'Ha! That\'s the smell of victory. Or scorched rat. Either way, the lane owes you a drink.',
  ...
  },
  {
    ...
    offer: 'Storm Crows circle the crypt like it is something dead. A bad omen, that, and I do not believe in omens. Clear 3 of them, then report to Headmaster Orvyn.',
  ...
  },
  {
    ...
    offer: 'Lord Hollowmere was a student here long ago, the brightest of his year, until he decided the shadows had more to teach him. He waits in the crypt at the end of Hollow Lane. Stock up on potions, then go and end his reign.',
  ...
  // ---------------- Chapter 2 ----------------
  {
    ...
    offer: 'Hollowmere\'s fall woke something older, and the land it sleeps under is burning. Our scouts in the Emberfall Wilds have gone silent. I have opened the Spiral Door on the west side of the courtyard. Step through and find Ranger Kestra.',
  ...
  },
  {
    ...
    offer: 'Magma Serpents rise out of the lava near the throne, all coils and teeth. They are the last thing between us and whatever rules this place. Defeat 3.',
    done: 'The path to the Molten Throne is open. I think you know who is waiting at the end of it.',
  ...
  },
  {
    ...
    done: 'Pyrrhon defeated?! The Emberfall Wilds are saved, and word of your deeds will spread through every land the Doors touch. Chapter 2 is complete, archmage. And yet... I sense your story has only just begun.',
