...
export const SETS = {
  ...
  deepwalker: { name: 'Deepwalker', pieces: ['deepwalker_hood', 'deepwalker_robe', 'deepwalker_boots', 'soulreaver_staff', 'deep_sigil'],
    bonus: [{ n: 2, stats: { resist: 8 } }, { n: 3, stats: { hp: 500 } }, { n: 5, stats: { dmg: 14 }, mods: { lifesteal: 0.06 }, desc: 'Heal for 6% of the damage you deal' }] },
  pale_regalia: { name: 'Pale Regalia', pieces: ['malvorens_crown', 'magisters_staff', 'pale_mantle', 'grimoire_of_ages', 'void_ring'],
    bonus: [{ n: 2, stats: { dmg: 12 } }, { n: 3, stats: { hp: 600, resist: 10 } }, { n: 5, mods: { big: 0.25, comboMeteor: 1 }, desc: '+25% damage to elites and bosses, and combo strikes call down meteors' }] },
