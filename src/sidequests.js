...
export const SIDE_QUESTS = [
  ...
  // ---------------- Emberfall Wilds ----------------
  {
    ...
    offer: 'Scout\'s secret: Emberroot tea keeps your fingers warm when the night wind comes down the canyon. It grows along the canyon walls, little red roots that glow like coals, and it burns the fingers of anyone without a forager\'s knack (Foraging 30). Bring me 6 and I will brew you a cup that tastes like a bonfire smells.',
  ...
  {
    id: 'ember2', mainQuest: 11, name: 'The Chanting Never Stops', giver: 'tumblewick', turnIn: 'tumblewick',
